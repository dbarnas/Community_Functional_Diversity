...
ggsave(here("Output","Species_vs_Cluster","V_richness_barplot.pdf"), plot1, height = 6, width = 6, device = "pdf")
ggsave(here("Output","Species_vs_Cluster","V_richness_boxplot.pdf"), plot1b, height = 6, width = 6, device = "pdf")
...
ggsave(here("Output","Species_vs_Cluster","V_richness_barplot_noSeep.pdf"), plot2, height = 10, width = 10, device = "pdf")
ggsave(here("Output","Species_vs_Cluster","V_richness_boxplot_noSeep.pdf"), plot2b, height = 10, width = 10, device = "pdf")
...
ggsave(here("Output","Species_vs_Cluster","V_percentCover_barplot.pdf"), plot3, height = 10, width = 10, device = "pdf")
ggsave(here("Output","Species_vs_Cluster","V_percentCover_boxplot.pdf"), plot3b, height = 10, width = 10, device = "pdf")
...
ggsave(here("Output","Species_vs_Cluster","V_percentCover_barplot_noSeep.pdf"), plot4, height = 10, width = 10, device = "pdf")
ggsave(here("Output","Species_vs_Cluster","V_percentCover_boxplot_noSeep.pdf"), plot4b, height = 10, width = 10, device = "pdf")
...
plot5 <- ggplot(graphdata5,
  ...
  labs(x="Varari Cluster",
       y="Species Richness",
       fill = "Relative SGD Influence",
       caption = paste("p =", round(x = ep, 3))) + # labels the x and y axes, legend, and caption
  scale_fill_manual(values=V_cluster_palette) #fill colors for the bars

plot5

# graph boxplot
plot5b <- ggplot(richnessT,
       aes(x = V_cluster,
           y = spR,
           fill = V_cluster)) +
  geom_boxplot(color = "black") +
...
ggsave(here("Output","Species_vs_Cluster","V_turb_ richness_barplot.pdf"), plot5, height = 10, width = 10, device = "pdf")
ggsave(here("Output","Species_vs_Cluster","V_turb_ richness_boxplot.pdf"), plot5b, height = 10, width = 10, device = "pdf")
...
plot6 <- ggplot(graphdata6,
  ...
  labs(x="Varari Cluster",
       y="Species Richness",
       fill = "Relative SGD Influence",
       caption = paste("p =", round(x = fp, 3))) + # labels the x and y axes, legend, and caption
  scale_fill_manual(values=V_cluster_palette) #fill colors for the bars

plot6

# graph boxplot
plot6b <- ggplot(richnessT,
       aes(x = V_cluster,
           y = spR,
           fill = V_cluster)) +
  geom_boxplot(color = "black") +
...
ggsave(here("Output","Species_vs_Cluster","V_turb_richness_barplot_noSeep.pdf"), plot6, height = 10, width = 10, device = "pdf")
ggsave(here("Output","Species_vs_Cluster","V_turb_richness_boxplot_noSeep.pdf"), plot6b, height = 10, width = 10, device = "pdf")
