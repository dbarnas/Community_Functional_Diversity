...
fd.coord.sgd <- read.csv(here("Data", "FE_4D_coord_dmb.csv"), row.names = 1)
...
# figure will show percentage of FE that have only one species representative
# and are therefore more vulnerable to potential species loss
