...
calcifiersComp <- comp %>%
  left_join(taxa) %>% 
  filter(Taxon_Group != 'Hard Substrate', Taxon_Group!= 'Sand') %>% 
  select(CowTagID, Taxa, Taxon_Group, sp_percent) %>% 
...
permanovamodel2<-adonis2(speciesPermFull2[,-c(52:56)]~VisibleHumidic_Like, speciesPermFull2, permutations = 999, 
                       method="bray") # should change out cowtagid with some grouping name
permanovamodel2 


permanovamodel2<-adonis2(speciesPermFull2[,-c(52:56)]~dist_to_seep_m, speciesPermFull2, permutations = 999, 
                       method="bray") # should change out cowtagid with some grouping name
permanovamodel2 # *

permanovamodel2<-adonis2(speciesPermFull2[,-c(52:56)]~Ammonia_umolL, speciesPermFull2, permutations = 999, 
                       method="bray") # should change out cowtagid with some grouping name
permanovamodel2 

permanovamodel2<-adonis2(speciesPermFull2[,-c(52:56)]~del15N, speciesPermFull2, permutations = 999, 
                       method="bray") # should change out cowtagid with some grouping name
permanovamodel2 
```
