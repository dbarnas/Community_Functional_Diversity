...
plotfun <- function(mydata = Full_data, x, y, myfacet, myformula) {
  ...
  facet_wrap(enquo(myfacet), scales = "free_y") +
...
```{r}
plotfun(x = NbSp, y = Values, myfacet = Parameters, myformula = "y~x", mydata = myturb)
plotfun(x = NbSp, y = Values, myfacet = Parameters, myformula = "y~poly(x,2)", mydata = myturb)

plotfun(x = NbFEs, y = Values, myfacet = Parameters, myformula = "y~x", mydata = myturb)
plotfun(x = NbFEs, y = Values, myfacet = Parameters, myformula = "y~poly(x,2)", mydata = myturb)

plotfun(x = Vol8D, y = Values, myfacet = Parameters, myformula = "y~x", mydata = myturb)
plotfun(x = Vol8D, y = Values, myfacet = Parameters, myformula = "y~poly(x,2)", mydata = myturb)
...
plotfun(x = NbSp, y = Maximum, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbSp, y = Maximum, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = NbFEs, y = Maximum, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbFEs, y = Maximum, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = Vol8D, y = Maximum, myfacet = Parameters, myformula = "y~x")
plotfun(x = Vol8D, y = Maximum, myfacet = Parameters, myformula = "y~poly(x,2)")
...
plotfun(x = NbSp, y = Minimum, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbSp, y = Minimum, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = NbFEs, y = Minimum, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbFEs, y = Minimum, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = Vol8D, y = Minimum, myfacet = Parameters, myformula = "y~x")
plotfun(x = Vol8D, y = Minimum, myfacet = Parameters, myformula = "y~poly(x,2)")
...
plotfun(x = NbSp, y = Range, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbSp, y = Range, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = NbFEs, y = Range, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbFEs, y = Range, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = Vol8D, y = Range, myfacet = Parameters, myformula = "y~x")
plotfun(x = Vol8D, y = Range, myfacet = Parameters, myformula = "y~poly(x,2)")
...
plotfun(x = NbSp, y = MeanSeasonal, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbSp, y = MeanSeasonal, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = NbFEs, y = MeanSeasonal, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbFEs, y = MeanSeasonal, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = Vol8D, y = MeanSeasonal, myfacet = Parameters, myformula = "y~x")
plotfun(x = Vol8D, y = MeanSeasonal, myfacet = Parameters, myformula = "y~poly(x,2)")
...
plotfun(x = NbSp, y = MeanAll, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbSp, y = MeanAll, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = NbFEs, y = MeanAll, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbFEs, y = MeanAll, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = Vol8D, y = MeanAll, myfacet = Parameters, myformula = "y~x")
plotfun(x = Vol8D, y = MeanAll, myfacet = Parameters, myformula = "y~poly(x,2)")
...
plotfun(x = NbSp, y = CVSeasonal, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbSp, y = CVSeasonal, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = NbFEs, y = CVSeasonal, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbFEs, y = CVSeasonal, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = Vol8D, y = CVSeasonal, myfacet = Parameters, myformula = "y~x")
plotfun(x = Vol8D, y = CVSeasonal, myfacet = Parameters, myformula = "y~poly(x,2)")
...
plotfun(x = NbSp, y = CVAll, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbSp, y = CVAll, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = NbFEs, y = CVAll, myfacet = Parameters, myformula = "y~x")
plotfun(x = NbFEs, y = CVAll, myfacet = Parameters, myformula = "y~poly(x,2)")

plotfun(x = Vol8D, y = CVAll, myfacet = Parameters, myformula = "y~x")
plotfun(x = Vol8D, y = CVAll, myfacet = Parameters, myformula = "y~poly(x,2)")
