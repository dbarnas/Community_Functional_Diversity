...
x_V <- V_data[,5:ncol(V_data)] # only biogeochemical and turb nutrient data
...
## create palette
V_cluster_palette <- c("brown3", "white", "#fad02c", "limegreen") #1 is dark yellow #2 is baby blue #3 is red #4 is lime green
...
#ggsave(here("Output","SGDZones","Varari",paste0("Varari_Cluster_Map_RangeTransScale.png")),cluster_varari_map,height = 10, width = 10)
...
#ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Varari_RangeTransScale.png")), Vbox, height = 20, width = 8)
...
#ggsave(here(paste0("Output","DiscPower_TurbRange_Varari.png")),Vdes_turb, height = 10, width = 10)
...
#ggsave(here("Output","SGDZones","Varari",paste0("Varari_Turb_Cluster_Map_RangeTransScale.png")),cluster_varari_map_turb,height = 10, width = 10)
...
#ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Turb_Varari_RangeTransScale.png")), Vbox_turb, height = 20, width = 8)
