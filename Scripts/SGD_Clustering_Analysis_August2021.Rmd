...
ggsave(here("Output","SGDZones","Varari",paste0("Varari_Turb_Cluster_Map_Range.png")),cluster_varari_map_turb,height = 10, width = 10)
...
ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Turb_Varari_Range.png")), Vbox_turb, height = 20, width = 8)
