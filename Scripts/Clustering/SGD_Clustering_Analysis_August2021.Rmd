...
ggsave(here("Output","Tissue_N_Silicate_Figures_CV.png"), fig_TornataN, height = 10, width = 16)
ggsave(here("Output","Tissue_N_Silicate_Figures_CV.pdf"), fig_TornataN, height = 10, width = 16)
...
pdf(here("Output","SGDZones","histograms",paste0("CV_Histograms.pdf")), onefile = TRUE)
...
# Save all plots in a single dated pdf
pdf(here("Output","SGDZones","histograms",paste0("Transformed_CV_Histograms.pdf")), onefile = TRUE)
for (i in seq(length(q))) {
  tplot <- q[[i]]
  print(tplot)
}
...
ggsave(here("Output","SGDZones","Varari",paste0("DiscPower_Varari_CV.png")),Vdes, height = 10, width = 10)
ggsave(here("Output","SGDZones","Varari",paste0("DiscPower_Varari_CV.pdf")),Vdes, height = 10, width = 10)
# ggsave(here("Output","SGDZones","Cabral",paste0("DiscPower_Cabral_CV.png")),Cdes, height = 10, width = 10)
...
V_Cluster_data<-V_data %>% 
  ...
  mutate(V_cluster = ifelse(V_cluster == 1, "Mid", V_cluster)) %>% 
  mutate(V_cluster = ifelse(V_cluster == 2, "High", V_cluster)) %>% 
  mutate(V_cluster = ifelse(V_cluster == 3, "Low", V_cluster)) %>% 
...
cluster_varari_map <- ggmap(VarariBaseMap) +
  ...
  labs(x = "Longitude", y = "Latitude",  #label x and y axes
       ...
       subtitle = "Transformed and Scaled Parameter CV",
       fill = "Relative SGD Influence") +
  scale_fill_manual(values = V_cluster_palette)

cluster_varari_map

ggsave(here("Output","SGDZones","Varari",paste0("Varari_Cluster_Map_CV.png")),cluster_varari_map,height = 7, width = 7)
ggsave(here("Output","SGDZones","Varari",paste0("Varari_Cluster_Map_CV.pdf")),cluster_varari_map,height = 7, width = 7)
...
cluster_cabral_map <- ggmap(CabralBaseMap) +
  ...
  labs(x = "Longitude", y = "Latitude",  #label x and y axes
      title = "Cabral, Clusters (LCM) \n Transformed and Scaled",
       subtitle = "Parameter Coefficient of Variation",
       color = "Cabral Clusters") +
  scale_fill_manual(values = C_cluster_palette)

cluster_cabral_map

#ggsave(here("Output","SGDZones","Cabral",paste0("Cabral_Cluster_Map_CVTransScale.png")),cluster_cabral_map,height = 10, width = 10)
...
#ggsave(plot = ClusterMaps, filename = here("Output","SGDZones","Cluster_Maps_CV.png"), width = 14, height = 10)
```
...
ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Varari_CV.png")), Vbox, height = 20, width = 8)
ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Varari_CV.pdf")), Vbox, height = 20, width = 8)

#ggsave(here("Output","SGDZones","Cabral",paste0("Boxplots_Cabral_CVTransScale.png")), Cbox, height = 20, width = 8)
```
...
#ggsave(plot = ClusterBoxPlots, filename = here("Output","SGDZones","Cluster_BoxPlots_CV.png"), width = 10, height = 14)
...
ggsave(here("Output","SGDZones","Varari","DiscPower_TurbCV_Varari.png"),Vdes_turb, height = 10, width = 10)
ggsave(here("Output","SGDZones","Varari","DiscPower_TurbCV_Varari.pdf"),Vdes_turb, height = 10, width = 10)
#ggsave(here(paste0("Output","DiscPower_TurbCV_Cabral.png")),Cdes_turb, height = 10, width = 10)
...
V_cluster_palette_turb <- c("#d8a7b1", "#e9ddd4", "#67595e") # 1 is rosewater, 2 is dusty rose, 3 is coffee pot
...
ggsave(here("Output","SGDZones","Varari","Varari_Turb_Cluster_Map_CV.png"),cluster_varari_map_turb,height = 10, width = 10)
ggsave(here("Output","SGDZones","Varari","Varari_Turb_Cluster_Map_CV.pdf"),cluster_varari_map_turb,height = 10, width = 10)
...
#ggsave(here("Output","SGDZones","Cabral",paste0("Cabral_Turb_Cluster_Map_CVTransScale.png")),cluster_cabral_map_turb,height = 10, width = 10)
...
ggsave(here("Output","SGDZones","Varari","Boxplots_Turb_Varari_CV.png"), Vbox_turb, height = 20, width = 8)
ggsave(here("Output","SGDZones","Varari","Boxplots_Turb_Varari_CV.pdf"), Vbox_turb, height = 20, width = 8)
#ggsave(here("Output","SGDZones","Cabral",paste0("Boxplots_Turb_Cabral_CVTransScale.png")), Cbox_turb, height = 20, width = 8)
