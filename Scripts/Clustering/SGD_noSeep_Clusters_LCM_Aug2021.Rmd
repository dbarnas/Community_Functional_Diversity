---
title: "SGD Clustering without VSEEP"
...
V_Cluster_data<-V_data %>% 
  ...
  mutate(V_cluster = ifelse(V_cluster == 3, "High", V_cluster)) %>% 
...
write_csv(SaveTransScale, here("Data","Surveys","Cluster_metadata_noSeep.csv"))
...
ggsave(here("Output","SGDZones","Varari",paste0("Varari_Cluster_Map_Range_noSeep.png")),cluster_varari_map,height = 10, width = 10)
ggsave(here("Output","SGDZones","Varari",paste0("Varari_Cluster_Map_Range_noSeep.pdf")),cluster_varari_map,height = 10, width = 10)
...
ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Varari_Range_noSeep.png")), Vbox, height = 20, width = 8)
ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Varari_Range_noSeep.pdf")), Vbox, height = 20, width = 8)
...
ggsave(plot = VarariPCA, filename = here("Output","SGDZones","Varari","VarariPCA_Range_noSeep.pdf"), width = 14, height = 6)
...
V_Cluster_data_turb<-V_data_turb %>% 
  ...
  mutate(V_cluster_turb = ifelse(V_cluster_turb == 2, "High", V_cluster_turb)) %>% 
  mutate(V_cluster_turb = ifelse(V_cluster_turb == 3, "Low", V_cluster_turb)) %>% 
  # as.factor and relevel cluster ID's
...
write_csv(SaveTransScale_turb, here("Data","Surveys","Cluster_turb_metadata_noSeep.csv"))
...
ggsave(here("Output","SGDZones","Varari","Varari_Turb_Cluster_Map_Range_noSeep.png"),cluster_varari_map_turb,height = 10, width = 10)
ggsave(here("Output","SGDZones","Varari","Varari_Turb_Cluster_Map_Range_noSeep.pdf"),cluster_varari_map_turb,height = 10, width = 10)
...
ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Turb_Varari_Range_noSeep.png")), Vbox_turb, height = 20, width = 8)
ggsave(here("Output","SGDZones","Varari",paste0("Boxplots_Turb_Varari_Range_noSeep.pdf")), Vbox_turb, height = 20, width = 8)
